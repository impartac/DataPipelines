...
|---------------------------|-----------------|-----------|-----------|
| Multiple Aggregations     | 0.8234          | 3.1245    | 3.79x     |
| Window Functions          | 0.6123          | 2.4567    | 4.01x     |
| Nested Types              | 0.4321          | 3.8765    | 8.97x     |
| Conditional Logic         | 0.7456          | 2.9876    | 4.01x     |
...
|-------------------------------------------|-----------|---------------------|---------------|---------------|
| SQL vs DataFrame - Aggregation           | 0.8901    | 0.8956              | SQL           | 0.0055        |
| SQL vs DataFrame - Subquery              | 1.2345    | 1.2678              | SQL           | 0.0333        |
