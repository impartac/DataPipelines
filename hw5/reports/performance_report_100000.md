...
|-----------------------|-------------------|-------------|-------------|
| Multiple Aggregations |            0.3335 |      7.2637 | 21.78x      |
| Window Functions      |            0.2404 |      1.9574 | 8.14x       |
| Nested Types          |            0.1695 |      1.6986 | 10.02x      |
| Conditional Logic     |            0.1567 |      6.3626 | 40.59x      |
...
|--------------------------------|-------------|-----------------------|---------------|-----------------|
| SQL vs DataFrame - Aggregation |      0.2044 |                0.2038 | DataFrame API |          0.0006 |
| SQL vs DataFrame - Subquery    |      0.2596 |                0.2662 | SQL           |          0.0067 |
...
*Отчет сгенерирован автоматически. Датасет: 100,000 строк.*
